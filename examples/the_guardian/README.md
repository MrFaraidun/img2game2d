# The Guardian — Armored Enforcer Showcase
...
| **Attack** | <img src="animations/attack.gif" width="160" alt="Attack"/> | 4 frames | 8 FPS | Kinetic strike sequence with high-energy displacement and weapon follow-through. |
...
- **4K Master POT Atlas**: [`atlases/the_guardian_atlas.png`](atlases/the_guardian_atlas.png) ($2048 \times 2048$) + JSON
- **FHD Game-Ready Atlas**: [`atlases/the_guardian_atlas_fhd.png`](atlases/the_guardian_atlas_fhd.png) ($1024 \times 1024$) + JSON
